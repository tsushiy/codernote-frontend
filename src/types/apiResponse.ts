...
export type ContestMap = Map<string, Contest>; // <Domain+ContestID, Contest>
...
export const isUserDetail = (
  userDetail: UserDetail
): userDetail is UserDetail =>
...
export const isProblem = (problem: Problem): problem is Problem =>
...
export const isContest = (contest: Contest): contest is Contest =>
...
export const isNote = (note: Note): note is Note =>
...
export const isNoteList = (noteList: NoteList): noteList is NoteList =>
  typeof noteList.Count === "number" && isNoteArray(noteList.Notes);

export const isTagList = (tagList: TagList): tagList is TagList =>
  isStringArray(tagList.Tags);

const isNumberArray = (array: number[]): array is number[] =>
  typeof array === "object" &&
  array !== null &&
...
const isNoteArray = (array: Note[]): array is Note[] =>
  typeof array === "object" &&
  array !== null &&
